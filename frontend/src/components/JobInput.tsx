    ...
    <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5 flex flex-col h-full shadow-lg">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="font-semibold text-white">2. Target Job Role & Specs</h2>
        </div>
        ...
        <div className="flex items-center space-x-2">
          {customJob ? (
            <button
              ...
              className="text-xs text-amber-400 hover:text-amber-300 flex items-center space-x-1 px-2.5 py-1 rounded-lg bg-amber-500/10 border border-amber-500/20"
            >
            ...
            <button
              ...
              className="text-xs text-indigo-400 hover:text-indigo-300 flex items-center space-x-1 px-2.5 py-1 rounded-lg bg-indigo-500/10 border border-indigo-500/20 transition"
            >
              <PlusCircle className="w-3.5 h-3.5" />
              <span>{isCustomMode ? "View Catalog" : "+ Custom Job"}</span>
            </button>
          )}
        </div>
      </div>
      ...
      {isCustomMode ? (
        ...
        <div className="flex-1 flex flex-col space-y-3">
          ...
          <div>
            <label className="block text-[11px] font-medium text-slate-400 mb-1">Target Seniority</label>
            <select
          ...
          <button
            ...
            className="w-full py-2 px-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 disabled:bg-slate-800 disabled:text-slate-500 text-white text-xs font-semibold flex items-center justify-center space-x-1.5 transition"
          >
            <Check className="w-3.5 h-3.5" />
            <span>Apply Custom Job Profile</span>
          </button>
        </div>
      ) : (
        ...
        <div className="flex-1 flex flex-col space-y-3">
          ...
          <div className="flex items-center space-x-2">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Search 12+ roles or skills..."
                value={searchQuery}
          ...
          >
            {customJob && <option value="custom">Custom Job: {customJob.title}</option>}
            {filteredJobs.map((j) => (
