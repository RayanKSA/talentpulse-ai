    ...
    <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5 flex flex-col h-full shadow-lg">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-2 rtl:space-x-reverse">
          ...
          <h2 className="font-semibold text-white">{t("resumeTitle")}</h2>
        </div>
        ...
        >
          ...
          {fileName ? (
            <div className="flex flex-col items-center space-y-2">
              ...
              <span className="text-xs text-slate-400">{t("dropzoneReplace")}</span>
            </div>
          ) : (
            <div className="flex flex-col items-center space-y-2">
              ...
              <p className="font-medium text-white text-sm">{t("dropzoneTitle")}</p>
        ...
        <div className="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          {wordCount > 0 && wordCount < 300 && (
            <span className="text-amber-400 flex items-center gap-1">
              <AlertCircle className="w-3 h-3" /> {t("brief")}
            </span>
          )}
          {wordCount >= 300 && wordCount <= 900 && (
            <span className="text-emerald-400 flex items-center gap-1">
              <CheckCircle2 className="w-3 h-3" /> {t("optimalLength")}
            </span>
          )}
        </div>
