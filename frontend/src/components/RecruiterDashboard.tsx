...
import { Users, Briefcase, Award, ArrowUpDown, Search, Download, CheckCircle2, XCircle, AlertCircle } from "lucide-react";
      ...
      <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5 shadow-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-lg font-bold text-white">Recruiter Candidate Benchmarking</h2>
          </div>
          <p className="text-xs text-slate-400 mt-1">
            Comparative multi-candidate ranking against target position specs
          </p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full bg-slate-900/80 border border-slate-800 rounded-xl pl-9 pr-3 py-2 text-xs text-slate-200 focus:outline-none focus:border-brand-500"
          />
        </div>
            ...
            <table className="w-full text-left text-xs text-slate-300">
              <thead className="bg-slate-950/70 border-b border-slate-800 text-slate-400 font-semibold uppercase tracking-wider text-[11px]">
                <tr>
                  ...
                  <th className="py-3.5 px-4">Candidate & Background</th>
                  <th className="py-3.5 px-4 text-center">Experience</th>
                  <th className="py-3.5 px-4 text-center">Overall Fit</th>
                  <th className="py-3.5 px-4 text-center">Skills Score</th>
                  <th className="py-3.5 px-4 text-center">ATS Audit</th>
                  <th className="py-3.5 px-4">Key Competencies & Gaps</th>
